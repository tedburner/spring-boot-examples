package com.sample.springboot.utils.exception.domain;
...
public class Error implements Serializable {
    ...
    public static class ErrorBuilder {
        ...
        public ErrorBuilder developerMessage(String developerMessage) {
            this.developerMessage = developerMessage;
            return this;
        }

        public ErrorBuilder moreInfo(String moreInfo) {
            this.moreInfo = moreInfo;
            return this;
        }

        public ErrorBuilder requestId(String requestId) {
            this.requestId = requestId;
            return this;
        }
